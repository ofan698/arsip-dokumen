                        ...
                        <tbody>
                            ...
                            <?php foreach ($standar1_saya as $lhs) : ?>
                                <tr>
                                    ...
                                    <td><p><?php echo $user['nama']; ?></p></td>
                                    <td><?php echo format_indo($lhs['date_upload']); ?></td>
                                    <td><a href="<?php echo base_url('user/file_download_standar1/' . $lhs['id']); ?>" class="btn btn-success btn-sm btn-block">Download</a></td>
                                    <td> <a href="<?php echo base_url('user/edit_standar1/' . $lhs['id']); ?>" class="btn btn-info btn-sm btn-block">Detail</a></td>
                                    <td><a href="<?php echo base_url('user/del_standar1/' . $lhs['id']); ?>" class="tombol-delete btn btn-danger btn-sm btn-block">Hapus</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" style="font-weight:800;">Standar 1</h3>
                <blockquote class="blockquote">Berisi tentang Visi, Misi, Tujuan dan Sasaran.</blockquote>
                
            </div>
            <div class="modal-body">
                <?php echo form_open_multipart('user/standar1'); ?>

                        ...
                        <tbody>
                            ...
                            <?php foreach ($standar3_saya as $lts) : ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url('user/file_download_standar3/' . $lts['id']); ?>" class="btn btn-success btn-sm btn-block">Download</a></td>
                                    <td> <a href="<?php echo base_url('user/edit_standar3/' . $lts['id']); ?>" class="btn btn-info btn-sm btn-block">Detail</a></td>
                                    <td><a href="<?php echo base_url('user/del_standar3/' . $lts['id']); ?>" class="tombol-delete btn btn-danger btn-sm btn-block">Hapus</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" style="font-weight:800;">Standar 3</h3>
                <blockquote class="blockquote">Berisi tentang Mahasiswa.</blockquote>
            </div>
            <div class="modal-body">
                <?php echo form_open_multipart('user/standar3'); ?>

            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table class=" table table-bordered table-hover" id="table-id" style="font_size:14px;">
                        ...
                        <tbody>
                            <?php $i = 1; ?>
                            <?php foreach ($standar5_saya as $sus) : ?>
                                <tr>
                                    <td><?php echo $i++; ?></td>
                                    ...
                                    <td><a href="<?php echo base_url('user/file_download_standar5/' . $sus['id']); ?>" class="btn btn-success btn-sm btn-block">Download</a></td>
                                    <td> <a href="<?php echo base_url('user/edit_standar5/' . $sus['id']); ?>" class="btn btn-info btn-sm btn-block">Detail</a></td>
                                    <td><a href="<?php echo base_url('user/del_standar5/' . $sus['id']); ?>" class="tombol-delete btn btn-danger btn-sm btn-block">Hapus</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" style="font-weight:800;">Standar 5</h3>
            </div>
            <div class="modal-body">
                <?php echo form_open_multipart('user/standar5'); ?>

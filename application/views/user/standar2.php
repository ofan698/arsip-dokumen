                        ...
                        <tbody>
                            ...
                            <?php foreach ($standar2_saya as $lbs) : ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url('user/file_download_standar2/' . $lbs['id']); ?>" class="btn btn-success btn-sm btn-block">Download</a></td>
                                    <td> <a href="<?php echo base_url('user/edit_standar2/' . $lbs['id']); ?>" class="btn btn-info btn-sm btn-block">Detail</a></td>
                                    <td><a href="<?php echo base_url('user/del_standar2/' . $lbs['id']); ?>" class="tombol-delete btn btn-danger btn-sm btn-block">Hapus</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" style="font-weight:800;">Standar 2</h3>
                <blockquote class="blockquote">Berisi tentang Tata Pamong dan Kerjasama.</blockquote>
            </div>
            <div class="modal-body">
                <?php echo form_open_multipart('user/standar2'); ?>

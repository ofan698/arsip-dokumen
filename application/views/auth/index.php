<head>
    <title>Login Form | Sistem Informasi Pengarsipan Dokumen Akreditasi</title>
...
<style type="text/css">
    body {
        background: url('<?php echo base_url(); ?>/assets/dist/img/pat_04.png') ;
    }
</style>
        ...
        <div id="loginbox" style="margin-top:20%;" class="mainbox col-md-4 col-md-offset-4 col-sm- col-sm-offset-2">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <div class="panel-title"><center>&bullet; Sistem Informasi Pengarsipan Dokumen &bullet;</center></div>
                </div>
